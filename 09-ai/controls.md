...
- **EVAL-010 in `evaluation-results.md` is a known, deliberate gap, not a bug.** It demonstrates that even every documented control passing is not a formal guarantee of correctness — see `evaluation.md`'s discussion of the inappropriate automation rate.
